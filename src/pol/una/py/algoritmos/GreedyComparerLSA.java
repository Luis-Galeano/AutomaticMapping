 ...
 * @author Luis Galeano
 */
public class GreedyComparerLSA {
...
//                    WNWordMetric wnMetricLin = new WNWordMetric(wNSimMeasure, wnFirstSenseOnly);
                    for (float wSim=0;wSim<=1.05f;wSim=wSim+0.1f){
                        for (boolean baseForm : Util.booleans){
                                    comparer.setGreedyComparerLSATasa(new GreedyComparer(new LSAWordMetric("LSA-MODEL-TASA-LEMMATIZED-DIM300"), wSim, baseForm));
                                    try{

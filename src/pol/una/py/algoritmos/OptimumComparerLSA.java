 ...
 * @author Luis Galeano
 */
public class OptimumComparerLSA {
                        ...
                        for (boolean baseForm : Util.booleans){
                            for (WordWeightType wordWeightType : PairwiseComparer.WordWeightType.values()){
                                for(NormalizeType normalizeType: PairwiseComparer.NormalizeType.values()){
                                    comparer.setOptimumComparerLSATasa(new OptimumComparer(new LSAWordMetric("LSA-MODEL-TASA-LEMMATIZED-DIM300"), wSim, baseForm, wordWeightType, normalizeType));
                                    try{

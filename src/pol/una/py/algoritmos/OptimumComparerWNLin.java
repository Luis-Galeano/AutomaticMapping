 ...
 * @author kpdevila
 */
public class OptimumComparerWNLin {
                        ...
                        for (boolean baseForm : Util.booleans){
                            for (WordWeightType wordWeightType : PairwiseComparer.WordWeightType.values()){
                                for(NormalizeType normalizeType: PairwiseComparer.NormalizeType.values()){
                                    comparer.setOptimumComparerWNLin(new OptimumComparer(wnMetricLin, wSim, baseForm, wordWeightType, normalizeType));
                                    try{
                                        //float [][] matriz = new float [itrust.length][hipaa.length];
                                        ...
                                        String a = "optimumComparerWNLin";
                                        String p = wNSimMeasure.toString()+" "+wnFirstSenseOnly+" "+wSim+" "+baseForm+" "+wordWeightType.toString()+" "+normalizeType.toString();
